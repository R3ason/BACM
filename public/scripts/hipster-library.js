...
var HipsterDictionary = (function(Window, undefined ){
	...
	var templates = [
		...
		'Where else can you find a {malt} malt paired with a {hop} hop, but in the Avery {name}?  Artisan before those kids even knew what it meant.',
		'The {adjective} qualities of this {name} make it totally {adjective}',
        ...
        'Avery\'s {name} completely revolutionizes the {cat} category. It\'s {adjective} use of the aromatic {hop} hops to balance out the {adjective} yeast results in a {adjective} beer you can bring to your mother',
